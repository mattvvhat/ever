...
MovingSurfaceApp.prototype.loop = App.prototype.loop;

function MovingSurfaceApp (el) {
  el = el || '';
...
// Init ___ App
MovingSurfaceApp.prototype.init = function () {
  var self = this;
  ...
  this.functional = new Functional(function (x, y, t) {
    ...
    return Math.cos(d + t) + 1/(2+Math.cos(x + t/10));
  });
...
// Update ___ App
MovingSurfaceApp.prototype.update = function () {
...
// Draw cube to scene
MovingSurfaceApp.prototype.draw = function () {
  this.renderer.render(this.scene, this.camera);
};

// !!!
MovingSurfaceApp.prototype.set = function (what, val) {
