...
function Couch (position, color) {
  var self = this;

  // Related to the Object
  self.obj_file = 'public/obj/Couch.obj';
  self.obj      = undefined;
...
Couch.prototype.load = function (file_name) {
  var self = this;
...
Couch.prototype.update = function () {
  var self = this;
...
/**
 * Draw a Couch
 * Draws a couch to a THREE.js scene. This may be unnecessary.
...
Couch.prototype.loaded = function (success) {
